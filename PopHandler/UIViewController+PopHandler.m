...
@implementation UIViewController (PopHandler)

@end

static NSString *const kOriginDelegate = @"kOriginDelegate";

@implementation UINavigationController (PopHandler)
...
+ (void)load
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        SEL swizzledSelector = @selector(pop_viewDidLoad);
...
- (void)pop_viewDidLoad
{
    [self pop_viewDidLoad];
